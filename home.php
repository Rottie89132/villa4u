...
<body>
  ...
  <main class="container container-fluid justify-content-center pt-5 ps-3 ps-3 pb-3">
  <div class="row row-cols-1 pt-3">
    <div class="col d-grid justify-content-center text-grid">
      <h1 class="text-center hero-header">Villa te koop</h1>
      <h6 class="text-center hero-p align-middle mb-5">
